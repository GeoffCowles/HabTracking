...
plt.title('Release of 800 particles on 7/2/2014')
...
plt.title('Release of 800 particles on 7/9/2014')
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.savefig("All_7_9_2014.png")
...
#    seconds.append(time[p,:])
    for i, j in zip(x[p,:], y[p,:]):
        if Point(i,j).within(polygon2) and time[p,0] == 6.48*10**5:
            plt.scatter(x[p,:], y[p,:],c = temp[p,:], s =0.1, marker = "o")
            #seconds.append(time[p,:])
            plt.scatter(x[p,0],y[p,0])
...
plt.title('7/9/14 800 Particle Release Point Within Polygon ')
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.savefig("7_9_14_release_Point_In_Polygon.png")
...
plt.title('Release of 800 particles on 7/16/2014')
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.savefig("All_7_16_2014.png")
...
#    seconds.append(time[p,:])
    for i, j in zip(x[p,:], y[p,:]):
        if Point(i,j).within(polygon2) and time[p,0] == 1.2528*10**6:
            plt.scatter(x[p,:], y[p,:],c = temp[p,:], s =0.1, marker = "o")
            #seconds.append(time[p,:])
            plt.scatter(x[p,0],y[p,0])
...
plt.title('7/16/14 800 Particle Release Point Within Polygon ')
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.savefig("7_16_14_release_Point_In_Polygon.png")
...
plt.title('Release of 800 particles on 7/23/2014')
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.savefig("All_7_23_2014.png")
...
#    seconds.append(time[p,:])
    for i, j in zip(x[p,:], y[p,:]):
        if Point(i,j).within(polygon2) and time[p,0] == 1.8576*10**6:
            plt.scatter(x[p,:], y[p,:],c = temp[p,:], s =0.1, marker = "o")
            #seconds.append(time[p,:])
            plt.scatter(x[p,0],y[p,0])
...
plt.title('7/23/14 800 Particle Release Point Within Polygon ')
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.savefig("7_23_14_release_Point_In_Polygon.png")
...
plt.title('Release of 800 particles on 7/30/2014')
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.savefig("All_7_30_2014.png")
...
#    seconds.append(time[p,:])
    for i, j in zip(x[p,:], y[p,:]):
        if Point(i,j).within(polygon2) and time[p,0] == 2.4624*10**6:
            plt.scatter(x[p,:], y[p,:],c = temp[p,:], s =0.1, marker = "o")
            #seconds.append(time[p,:])
            plt.scatter(x[p,0],y[p,0])
...
plt.title('7/30/14 800 Particle Release Point Within Polygon ')
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.savefig("7_30_14_release_Point_In_Polygon.png")