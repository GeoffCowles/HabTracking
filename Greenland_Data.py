...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 19 18:14:38 2022
...
ncfile = '/home/lcabral4/WHOI/HAB3/HabTracking/float_output/Greenland1.nc'
...
plt.title('Line Release of 800 particles on 7/2/2014')
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.savefig("Greenland_All_7_2_2014.png")
...
plt.title('7/2/14 800 Particle Line Release Point Within Polygon ')
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.savefig("Greenland)7_2_14_release_Point_In_Polygon.png")
...
np.savetxt('Greenland_particle_time_7_2_2014.txt', dat ,header = 'particle number               times')#,delimiter = ',')